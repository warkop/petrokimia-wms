...
class LogAktivitasUserController extends Controller
{
    /**
    ...
    public function json(Request $req)
    {
        ...
        if ($page >= 0) {
            ...
            $result = LogActivityResource::collection($models::get());
        ...
        return response()->json($this->responseData, $this->responseCode);# code...
    }

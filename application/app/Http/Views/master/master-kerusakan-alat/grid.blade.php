		...
		<div class="kt-portlet__head">
			<div class="kt-portlet__head-title">
                <h4 class="kt-portlet__head-text title_sub pt-4">
                    ...
                    Data Master Kerusakan Alat Berat
                </h4>
                <p class="sub">
                    Berikut ini adalah data master kerusakan alat berat yang tercatat pada <span class="text-ungu kt-font-bolder">Aplikasi WMS Petrokimia.</span>
                </p>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Masukkan nama kerusakan">
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<script src="{{asset('assets/extends/js/page/master-kerusakan.js')}}" type="text/javascript"></script>
<script>

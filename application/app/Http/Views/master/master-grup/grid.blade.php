	...
	<div class="kt-portlet">
		<div class="kt-portlet__head">
			<div class="kt-portlet__head-title">
                ...
                <p class="sub">
                    Berikut ini adalah data master grup yang tercatat pada <span class="text-ungu kt-font-bolder">Aplikasi WMS Petrokimia.</span>
                </p>
            </div>
...
<script src="{{asset('assets/extends/js/page/master-grup.js')}}" type="text/javascript"></script>
<script>

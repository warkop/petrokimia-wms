                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control pwd" placeholder="Password" aria-describedby="basic-addon2">
                            ...
                            <div class="form-group">
                                ...
                                <span class="mr-2">
                                    ...
                                    <label for="radio2">Departemen</label>
                                </span>
                                <span class="mr-2">
                                    <input type="radio" id="radio3" name="radios" value="true">
                                    <label for="radio3">Checker</label>
                                </span>
                                <span class="mr-2">
                                    <input type="radio" id="radio4" name="radios" value="true">
                                    <label for="radio4">Loket</label>
                                </span>  
                            </div>
                        </div>
                    </div>

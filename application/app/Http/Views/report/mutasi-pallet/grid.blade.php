...
<script>
    document.getElementById('report-mutasi-pallet-nav').classList.add('kt-menu__item--active');
</script>
    ...
    <div class="kt-portlet">
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-title">
                <h4 class="kt-portlet__head-text title_sub pt-4">
                    Laporan Mutasi Pallet
                </h4>
                <p class="sub">
                    Berikut ini adalah form report mutasi pallet pada <span class="text-ungu kt-font-bolder">Aplikasi WMS
                        Petrokimia.</span>
                </p>
            </div>
        </div>
        ...
        <div class="kt-portlet__body">
            ...
            <div class="form-group row">
                <h4 class="col-2 col-form-label text-kiri">Pallet</h4>
                <div class="col-6">
            ...
            <div class="kt-form__actions">
                <div class="row">
                    <div class="offset-lg-2">
                        ...
                        <button type="button" onclick="cetak('mutasi-pallet')" class="btn btn-success" download=""> <i class="fa fa-print"></i> Cetak Laporan</button>
                        <button type="button" onclick="cetak('mutasi-pallet','preview')" class="btn btn-warning" download=""> <i class="fa fa-binoculars "></i> Preview Laporan</button>
                    </div>
                </div>
            </div>
        </div>

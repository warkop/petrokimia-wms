            ...
            <div class="kt-form__actions">
                <div class="row">
                    <div class="offset-lg-2">
                        ...
                        <button type="button" onclick="cetak('stok')" class="btn btn-success" download=""> <i class="fa fa-print"></i> Cetak Laporan</button>
                        <button type="button" onclick="cetak('stok','preview')" class="btn btn-warning" download=""> <i class="fa fa-binoculars "></i> Preview Laporan</button>
                    </div>
                </div>
            </div>
        </div>

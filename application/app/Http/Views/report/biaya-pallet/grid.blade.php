...
@section('title', 'Biaya Pallet')

@section('content')

<script>
    document.getElementById('report-biaya-pallet-nav').classList.add('kt-menu__item--active');
</script>
        ...
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-title">
                <h4 class="kt-portlet__head-text title_sub pt-4">
                    Laporan Biaya Pallet
                </h4>
                <p class="sub">
                    Berikut ini adalah form report biaya pallet pada <span class="text-ungu kt-font-bolder">Aplikasi WMS
                        Petrokimia.</span>
                </p>
            </div>
        </div>
            ...
            <div class="kt-form__actions">
                <div class="row">
                    <div class="offset-lg-2">
                        <button type="button" onclick="cetak('biaya-pallet')" class="btn btn-success" download=""> <i class="fa fa-print"></i> Cetak Laporan</button>
                        <button type="button" onclick="cetak('biaya-pallet','preview')" class="btn btn-warning" download=""> <i class="fa fa-binoculars "></i> Preview Laporan</button>
                    </div>
                </div>
            </div>
        </div>

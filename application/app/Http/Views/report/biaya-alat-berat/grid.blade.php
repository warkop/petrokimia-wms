...
@section('title', 'Biaya Alat Berat')

@section('content')

<script>
    document.getElementById('report-biaya-alat-berat-nav').classList.add('kt-menu__item--active');
</script>
    ...
    <div class="kt-portlet">
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-title">
                <h4 class="kt-portlet__head-text title_sub pt-4">
                    Laporan Biaya Alat Berat
                </h4>
                <p class="sub">
                    Berikut ini adalah form report biaya alat berat pada <span class="text-ungu kt-font-bolder">Aplikasi WMS
                        Petrokimia.</span>
                </p>
            </div>
        </div>
        ...
        <div class="kt-portlet__body">
            ...
            <div class="form-group row">
                ...
                <div class="col-6">
                    <select class="form-control m-select2" id="jenis_alat_berat" name="jenis_alat_berat[]" multiple="multiple" style="width: 100%">
                         @foreach ($jenisAlatBerat as $item)
                            <option value="{{$item->id}}">{{$item->nama}}</option>
                        @endforeach
                    </select>
                </div>
            ...
            <div class="kt-form__actions">
                <div class="row">
                    <div class="offset-lg-2">
                        <button type="button" onclick="cetak('biaya-alat-berat')" class="btn btn-success" download=""> <i class="fa fa-print"></i> Cetak Laporan</button>
                        <button type="button" onclick="cetak('biaya-alat-berat','preview')" class="btn btn-warning" download=""> <i class="fa fa-binoculars "></i> Preview Laporan</button>
                    </div>
                </div>
            </div>
        </div>

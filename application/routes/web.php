...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::group(['prefix' => 'penerimaan-gp', 'middleware' => 'can:penerimaan-gp'], function () {
        ...
        Route::post('/{aktivitasHarian}', 'PenerimaanGpController@store')->where('aktivitasHarian', '[0-9]+');
    ...
    Route::group(['prefix' => 'log-aktivitas'], function () {
        ...
        Route::get('/cetak-aktivitas-cancel/{id}', 'LogAktivitasController@print_cancel')->where('id', '[0-9]+');
    });
    ...
    Route::group(['prefix' => 'report', 'middleware' => ['can:report']], function () {
        ...
        Route::get('/laporan-cancellation', 'ReportController@laporanCancellation');

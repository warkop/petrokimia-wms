...
var KTDashboard = function() {
    ...
    // init tabel SWK
    var initTableSWK = function() {
		var table = $('#kt_table_swk');
			...
			columnDefs: [
				{
					...
					render: function(data, type, full, meta) {
						return `
                        <a href="" class="btn btn-outline-success btn-elevate btn-circle btn-icon" data-toggle="modal" data-target="#modal_swk" title="Edit">
                          <i class="la la-edit"></i>
                        </a>
                        <a href="" id="kt_sweetalert_delete" class=" btn btn-outline-danger btn-elevate btn-circle btn-icon" data-toggle="kt-tooltip" data-placement="top" title="Delete">
                ...
                },
                {
					...
					render: function(data, type, full, meta) {
						return `
                        <a href="swk/tenants" class="btn btn-success btn-elevate btn-circle " data-toggle="kt-tooltip" title="Edit" data-placement="top">
    ...
    // init tabel Tenants
    var initTableTenants = function() {
		var table = $('#kt_table_tenants');
			...
			columnDefs: [
				{
					...
					render: function(data, type, full, meta) {
						return `
                        <a href="" class="btn btn-outline-success btn-elevate btn-circle btn-icon" data-toggle="modal" data-target="#modal_tenant_edit" title="Edit">
                          <i class="la la-edit"></i>
                        </a>
                        <a href="" id="kt_sweetalert_delete" class="btn btn-outline-danger btn-elevate btn-circle btn-icon" data-toggle="kt-tooltip" data-placement="top" title="Delete">
                          <i class="la la-trash"></i>
                ...
                },
                {
					...
					render: function(data, type, full, meta) {
                        ...
                        <a href="" class="btn btn-warning btn-elevate btn-circle " data-toggle="modal" data-target="#modal_tenant_produk" title="Edit Produk" data-placement="top">
                        <i class="flaticon2-edit"></i>
                        <span>Produk Tenant</span>
                      </a>
                        `;
					},
				}
    ...
    // init tabel Pedagang
    var initTablePedagang = function() {
		var table = $('#kt_table_pedagang');
			...
			columnDefs: [
				{
					...
					render: function(data, type, full, meta) {
						return `
                        <a href="" class="btn btn-outline-success btn-elevate btn-circle btn-icon" data-toggle="modal" data-target="#modal_pedagang" title="Edit">
                          <i class="la la-edit"></i>
                        </a>
                        <a href="" class="btn_sa_delete btn btn-outline-danger btn-elevate btn-circle btn-icon" data-toggle="kt-tooltip" data-placement="top" title="Delete">
                          <i class="la la-trash"></i>
                        </a>
                        `;
					},
			...
			columnDefs: [
				{
					...
					render: function(data, type, full, meta) {
						return `
                        <a href="" class="btn btn-outline-success btn-elevate btn-circle btn-icon" data-toggle="modal" data-target="#modal_user" title="Edit">
                          <i class="la la-edit"></i>
                        </a>
                        <a href="" class="btn_sa_delete btn btn-outline-danger btn-elevate btn-circle btn-icon" data-toggle="kt-tooltip" data-placement="top" title="Delete">
                          <i class="la la-trash"></i>
    ...
    // init tabel retr
    var initTableRetribusi = function() {
		var table = $('#kt_table_retribusi');
			...
			columnDefs: [
				{
					...
					render: function(data, type, full, meta) {
						return `
                        <a href="" class="btn btn-outline-success btn-elevate btn-circle btn-icon" data-toggle="modal" data-target="#modal_retribusi" title="Edit">
                          <i class="la la-edit"></i>
                        </a>
                        <a href="" class="btn_sa_delete btn btn-outline-danger btn-elevate btn-circle btn-icon" data-toggle="kt-tooltip" data-placement="top" title="Delete">
                          <i class="la la-trash"></i>
    ...
    var trendsStats = function() {
        ...
        gradient.addColorStop(0, Chart.helpers.color('#00B294').alpha(0.7).rgbString());
        gradient.addColorStop(1, Chart.helpers.color('#008CB2').alpha(0.3).rgbString());
    ...
    //MENU TERLARIS
    var trendsMenu = function() {
        if ($('#kt_chart_trends_menu').length == 0) {
            return;
        }

        var ctx = document.getElementById("kt_chart_trends_menu").getContext("2d");

        var gradient = ctx.createLinearGradient(0, 0, 0, 240);
        gradient.addColorStop(0, Chart.helpers.color('#00B294').alpha(0.9).rgbString());
        // gradient.addColorStop(1, Chart.helpers.color('#00B294').alpha(0.3).rgbString());
        gradient.addColorStop(1, Chart.helpers.color('#008CB2').alpha(0.5).rgbString());

        var config = {
            type: 'horizontalBar',
            data: {
                labels: [
                    "Soto", "Rawon", "Pecel", "Nasi Bebek", "Tahu Campur", "Gurami Bakar", "Tahu Tek", "Ketoprak", "Lontong Balap", "Rujak Cingur", 
       ...
       //TENANT TERLARIS
    var trendsTenant = function() {
        if ($('#kt_chart_trends_tenant').length == 0) {
            return;
        }

        var ctx = document.getElementById("kt_chart_trends_tenant").getContext("2d");
        ...
        var config = {
            ...
            data: {
                labels: [
                    "Rawon Setan", "Pecel Nganjuk", "Mie Setan", "Bebek Bagong", "Tahu Walik Suki", "Guramie", "Tek Tek Jos", "Jakarta Kuliner", "Lontongkoe", "Rujak Kito", 
                ...
                datasets: [{
                    ...
                    //fill: 'start',
                    data: [
                        800, 630, 583, 535, 450, 355, 332, 228, 176, 192,
                    ]
                }]
            },
            options: {

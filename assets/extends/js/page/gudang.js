            ...
            columnDefs: [{
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        <a href="` + baseUrl + `/list-pallet">
                            <button type = "button" class="btn btn-warning btn-elevate btn-icon" data-container="body" data-toggle="kt-tooltip" data-placement="top" title="List Pallet">
                            <i class="flaticon-layers"></i></button>
                        </a>
                        <a href="` + baseUrl + `/list-tenaga-kerja-nonorganik">
                            <button type = "button" class="btn btn-primary btn-elevate btn-icon" data-container="body" data-toggle="kt-tooltip" data-placement="top" title="List Tenaga Non Organik">

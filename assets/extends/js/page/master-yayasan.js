...
let datatable,
    ...
    ajaxUrl = baseUrl + 'master-yayasan',
    ajaxSource = ajaxUrl,
    laddaButton;
...
function tambah() {
    ...
    $('#modal_form .modal-title').html('Tambah Data Yayasan');
    $('#modal_form .modal-info').html('Isilah form dibawah ini untuk menambahkan data terkait master Yayasan.');
    $('#modal_form').modal({
        backdrop: 'static',
        keyboard: false
    }, 'show');
...
function edit(id = '') {
    ...
    $('#modal_form .modal-title').html('Edit Data Yayasan');
    $('#modal_form .modal-info').html('Isilah form dibawah ini untuk mengubah data master Yayasan sesuai kebutuhan.');
    $('#modal_form').modal({
        backdrop: 'static',
        keyboard: false
    }, 'show');

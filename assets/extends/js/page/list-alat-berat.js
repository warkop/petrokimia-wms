        ...
        "aoColumnDefs": [{
            ...
            },
            {
                ...
                render: function (data, type, full, meta) {
                    let kata = '';
                    if (full.status == 1) {
                        kata = '<span class="kt-badge kt-badge--inline kt-badge--success">Aktif</span>';
                    } else {
                        kata = '<span class="kt-badge kt-badge--inline kt-badge--danger">Rusak</span>';
                    }
                    return kata;
                },
            },
...
function tambah() {
    ...
    $('#modal_form .modal-info').html('Isilah form dibawah ini untuk menambahkan data terkait master List Alat Berat.');
    $('#modal_form').modal({
        backdrop: 'static',
        keyboard: false
    }, 'show');
...
function edit(id = '') {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (obj.status == "OK") {
                $('#nomor_lambung').val(obj.data['nomor_lambung']);
                $('#nomor_polisi').val(obj.data['nomor_polisi']);
            } else {

...
function tambah() {
    ...
    $('#modal_form .modal-title').html('Tambah Data Kepala Regu');
    $('#modal_form .modal-info').html('Isilah form dibawah ini untuk menambahkan data terkait master Kepala Regu.');
    $('#modal_form').modal({
        backdrop: 'static',
        keyboard: false
    }, 'show');

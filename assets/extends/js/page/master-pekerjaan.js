...
function tambah() {
    ...
    $('#modal_form .modal-info').html('Isilah form dibawah ini untuk menambahkan data terkait master Job Desk.');
    $('#modal_form').modal({
        backdrop: 'static',
        keyboard: false
    }, 'show');
...
function edit(job_desk_id = '') {
    ...
    $('#modal_form .modal-info').html('Isilah form dibawah ini untuk mengubah data master Job Desk sesuai kebutuhan.');
    $('#modal_form').modal({
        backdrop: 'static',
        keyboard: false
    }, 'show');

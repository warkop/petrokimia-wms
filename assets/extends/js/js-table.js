...
// Class definition
var KTAppPelayanan = function() {
    var initTable2 = function() {
		var table = $('#kt_table_pertanyaan');
			...
			columnDefs: [
				{
					...
					render: function(data, type, full, meta) {
						return `
                        <a href="" class="btn btn-outline-success btn-elevate btn-circle btn-icon" data-toggle="modal" data-target="#edit_barang" title="Edit">
    ...
    var initTableSaran = function() {
		var table = $('#kt_table_saran');
    ...
    var question1 = function() {        
        if (!KTUtil.getByID('kt_chart_question1')) {
            return;
        }
        ...
        var ctx = KTUtil.getByID('kt_chart_question1').getContext('2d');
        var myDoughnut = new Chart(ctx, config);
    }
    var question2 = function() {        
        if (!KTUtil.getByID('kt_chart_question2')) {
            return;
        }
        ...
        var ctx = KTUtil.getByID('kt_chart_question2').getContext('2d');
        var myDoughnut = new Chart(ctx, config);
    }
    var question3 = function() {        
        if (!KTUtil.getByID('kt_chart_question3')) {
            return;
        }
        ...
        var ctx = KTUtil.getByID('kt_chart_question3').getContext('2d');
        var myDoughnut = new Chart(ctx, config);
    }
    var question4 = function() {        
        if (!KTUtil.getByID('kt_chart_question4')) {
            return;
        }
        ...
        var ctx = KTUtil.getByID('kt_chart_question4').getContext('2d');
        var myDoughnut = new Chart(ctx, config);
    }
    var question5 = function() {        
        if (!KTUtil.getByID('kt_chart_question5')) {
            return;
        }
        ...
        var ctx = KTUtil.getByID('kt_chart_question5').getContext('2d');
        var myDoughnut = new Chart(ctx, config);
    }
    ...
    var orderStatistics = function() {
        ...
        var MONTHS = ['Fasilitasi Gedung', 'Keramahan', 'Kecepatan', 'Manfaat Produk', 'Transparasi Penjelasan'];

        var color = Chart.helpers.color;
        var barChartData = {
            labels: ['Fasilitasi Gedung', 'Keramahan', 'Kecepatan', 'Manfaat Produk', 'Transparasi Penjelasan'],
            datasets : [
                
                {
                    ...
                    borderColor : color(KTApp.getStateColor('success')).alpha(0.9).rgbString(),
                ...
                },
				{
                    fill: true,
                    borderWidth: 1,
					backgroundColor : color(KTApp.getStateColor('info')).alpha(0.7).rgbString(),
                    borderColor : color(KTApp.getStateColor('info')).alpha(0.9).rgbString(),
                ...
                },
				{
                    ...
                    borderColor : color(KTApp.getStateColor('warning')).alpha(1).rgbString(),
				...
				},
                {
                    ...
                    borderColor : color(KTApp.getStateColor('danger')).alpha(0.9).rgbString(),
    ...
    var datatableLatestOrders = function() {
        ...
        // Latest Orders
        var datatableLatestOrders = function() {
            if ($('#kt_datatable_pertanyaan').length === 0) {
                return;
            }
